            ...
            <View style={{ flex: 1, backgroundColor: '#f3f5f9' }}>
                ...
                <TouchableOpacity onPress={() => this._buttonFloatingPressed()} style={{
                    ...
                    <Animated.View style={{ transform: [{ rotate: rotateIcon }] }}>
                        <Icon type={'MaterialIcons'} name={'add'} size={32} color="white" />
                    </Animated.View>
                </TouchableOpacity>
                <Animated.View
                ...
                >
                    <FloatingChild nameButton="Scan" iconColor="white" iconSize={20} iconName="barcode-scan" iconType="MaterialCommunityIcons" />
                    <FloatingChild nameButton="Search" iconColor="white" iconSize={20} iconName="search" iconType="Feather" />
                </Animated.View>
            </View>
        )
    }
